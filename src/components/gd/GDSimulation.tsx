...
const GDSimulation: React.FC = () => {
  ...
  const endSession = () => {
    ...
    // In a real app, this would navigate to feedback page
  };
            ...
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-white/20">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm text-gray-800">Good use of supporting data!</p>
                </div>
                <div className="flex items-start space-x-3 p-3 bg-yellow-50 rounded-lg">
                  <AlertCircle className="h-5 w-5 text-yellow-600 mt-0.5" />
                  <p className="text-sm text-gray-800">Try to engage more with other participants' points</p>
                </div>
                <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                  <TrendingUp className="h-5 w-5 text-green-600 mt-0.5" />
                  <p className="text-sm text-gray-800">Your speaking pace is excellent</p>
                </div>
              </div>
            </div>
          </div>
              ...
              >
                ...
                <div className="space-y-3">
                  <Link
                    ...
                    className="block w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-6 rounded-xl font-medium hover:from-green-600 hover:to-emerald-700 transition-all duration-200"
                  >
                    View Feedback
                  </Link>
                  <Link
                    to="/topics"
                    className="block w-full bg-gray-100 text-gray-700 py-3 px-6 rounded-xl font-medium hover:bg-gray-200 transition-all duration-200"
                  >
                    Try Another Topic
                  </Link>
                </div>
